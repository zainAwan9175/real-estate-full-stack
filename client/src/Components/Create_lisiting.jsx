...
function Create_lisiting() {
  ...
  function send_data_to_backend(e) {
    ...
    axios
      .post("http://localhost:3001/listining/create", formdata)
      .then((res) => {
  ...
  return (
    <div className='flex justify-center items-center flex-col min-h-[88vh] p-10'>
      <form onSubmit={send_data_to_backend} className='flex flex-col gap-2 bg-white shadow-2xl p-4 pt-9 pb-9 rounded-xl'>
        <p className='text-blue-500 font-bold text-[25px] md:text-[30px] text-center'>Create a Listing</p>
...
<div className='flex gap-6 flex-wrap'>
          ...
          <div className='w-[300px] md:w-[400px] flex flex-col gap-4'>
            ...
            <button type='submit' className='w-full text-white bg-blue-600 outline-none p-2 mt-4 rounded-md hover:bg-blue-900 hover:text-white hover:duration-500' >Create Listing</button>
...
export default Create_lisiting;
