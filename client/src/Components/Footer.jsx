  ...
  <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        ...
        <a
            href="/"
            className="flex md:mb-4 items-center space-x-3 rtl:space-x-reverse"
          >
            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white text-gray-400">
     ...
     <h1 className='text-slate-400 font-bold  '> Find your next <span className='text-blue-500'>perfect </span><br></br>
     place with ease</h1>
     <h2 className='text-[13px]  text-slate-500  pr-6'>
     Zain Estate will help you find your home fast, easy and comfortable.<br></br>
